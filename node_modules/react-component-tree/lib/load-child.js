...
var isClassComponent = function isClassComponent(Component) {
  return Component && Component.prototype && (typeof Component.prototype.render === 'function' || 'displayName' in Component.prototype.constructor);
};

var getChildParams = function getChildParams(component, childName, a, b, c, d, e, f) {
...
exports.loadChild = function (component, childName, a, b, c, d, e, f) {
   ...
   * });
   */
  var params = getChildParams.call(undefined, component, childName, a, b, c, d, e, f);

  // One child with bad params shouldn't block the entire app
  try {
    return _react2.default.createElement(params.component, (0, _lodash2.default)(params, 'component', 'children'), params.children);
  } catch (err) {
    console.error(err);
    return null;
  }
